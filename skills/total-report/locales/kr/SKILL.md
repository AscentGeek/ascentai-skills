...
### Step 4 · 도구 호출 · MCP 도구(intent_finder · cluster_finder · path_finder · keyword_info) · tool_call 은 **직접 발행**
...
MCP 도구(intent_finder · cluster_finder · path_finder · keyword_info)는 optional `user_query` 파라미터를 받아 이력에 적재한다
